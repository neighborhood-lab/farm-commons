...
export const createWorkerSchema = z.object({
  ...
  hire_date: z.string().or(z.date()).transform((val) => new Date(val)),
...
export const createCertificationSchema = z.object({
  ...
  expiration_date: z.string().or(z.date()).transform((val) => new Date(val)).optional().nullable(),
