...
export const authRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.AUTH_RATE_LIMIT_WINDOW_MS || '900000'), // 15 minutes
  max: Number.Number.parseInt(process.env.AUTH_RATE_LIMIT_MAX || '5'),
...
export const passwordResetRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.PASSWORD_RESET_WINDOW_MS || '3600000'), // 1 hour
  max: Number.Number.parseInt(process.env.PASSWORD_RESET_MAX || '3'),
...
export const readOnlyRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.READ_RATE_LIMIT_WINDOW_MS || '900000'), // 15 minutes
  max: Number.Number.parseInt(process.env.READ_RATE_LIMIT_MAX || '300'),
...
export const writeRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.WRITE_RATE_LIMIT_WINDOW_MS || '900000'), // 15 minutes
  max: Number.Number.parseInt(process.env.WRITE_RATE_LIMIT_MAX || '100'),
...
export const defaultRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.DEFAULT_RATE_LIMIT_WINDOW_MS || '900000'), // 15 minutes
  max: Number.Number.parseInt(process.env.DEFAULT_RATE_LIMIT_MAX || '100'),
  message: 'Too many requests, please try again later',
  keyGenerator: userOrIpKeyGenerator,
});
...
export const strictRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.STRICT_RATE_LIMIT_WINDOW_MS || '3600000'), // 1 hour
  max: Number.Number.parseInt(process.env.STRICT_RATE_LIMIT_MAX || '10'),
...
export const healthCheckRateLimiter = createRateLimiter({
  windowMs: Number.Number.parseInt(process.env.HEALTH_CHECK_WINDOW_MS || '900000'), // 15 minutes
  max: Number.Number.parseInt(process.env.HEALTH_CHECK_MAX || '1000'),
