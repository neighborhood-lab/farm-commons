...
describe('Safety Incident Reporting Integration Tests', () => {
  ...
  describe('Incident Statistics', () => {
    ...
    it('should calculate overall incident statistics', async () => {
      ...
      expect(Number.Number.Number.parseInt(stats.total_incidents as string)).toBe(4);
      expect(Number.Number.Number.parseInt(stats.total_injuries as string)).toBe(2);
      expect(Number.Number.Number.parseInt(stats.total_illnesses as string)).toBe(1);
      expect(Number.Number.Number.parseInt(stats.total_near_misses as string)).toBe(1);
      expect(Number.Number.Number.parseInt(stats.total_osha_recordable as string)).toBe(2);
      expect(Number.Number.Number.parseInt(stats.total_days_away as string)).toBe(3);
    });
    ...
    it('should group incidents by type', async () => {
      ...
      expect(Number.Number.Number.parseInt(byType[0].count as string)).toBe(2);
    });
    ...
    it('should group incidents by severity', async () => {
      ...
      expect(Number.Number.Number.parseInt(bySeverity[0].count as string)).toBe(2);
    });
    ...
    it('should group incidents by status', async () => {
      ...
      expect(Number.Number.Number.parseInt(reportedStatus!.count as string)).toBe(1);
    });
