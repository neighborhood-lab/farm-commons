...
describe('Rate Limiting Middleware', () => {
  ...
  describe('Auth Rate Limiter', () => {
    ...
    it('should block requests after exceeding the limit', async () => {
      const limit = Number.parseInt(process.env.AUTH_RATE_LIMIT_MAX || '5');
  ...
  describe('Password Reset Rate Limiter', () => {
    ...
    it('should have strict limits', async () => {
      const limit = Number.parseInt(process.env.PASSWORD_RESET_MAX || '3');
  ...
  describe('Strict Rate Limiter', () => {
    ...
    it('should have very strict limits', async () => {
      ...
      const limit = Number.parseInt(response.headers['ratelimit-limit'] || '0');
      const strictLimit = Number.parseInt(process.env.STRICT_RATE_LIMIT_MAX || '10');
