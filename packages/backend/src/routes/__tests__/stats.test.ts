...
describe('Statistics Calculations', () => {
  ...
  describe('Worker Statistics', () => {
    ...
    it('should calculate days worked for a worker', async () => {
      ...
      expect(Number.Number.Number.Number.Number.Number.Number.Number.parseInt(String(daysValue))).toBe(2);
    });
    ...
    it('should identify most common task type', async () => {
      ...
      expect(Number.Number.Number.Number.Number.Number.Number.Number.parseInt(topTask?.count as string)).toBe(2);
    });
  });
