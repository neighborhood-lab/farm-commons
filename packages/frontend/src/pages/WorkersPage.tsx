        ...
        {workers.map((worker) => (
          ...
          >
            ...
            <div className="flex items-start gap-4 mb-4">
              <div className="w-12 h-12 bg-earth-500 dark:bg-earth-600 text-white rounded-full flex items-center justify-center font-semibold text-lg">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-wrap gap-1">
                  {worker.skills.slice(0, 3).map((skill) => (
                    <span
                      key={skill}
                      className="px-2 py-1 bg-sage-100 dark:bg-sage-900/50 text-sage-700 dark:text-sage-300 text-xs rounded"
                    >
                      {skill}
                    </span>
                  ))}
